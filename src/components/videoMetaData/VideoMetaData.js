      ...
      <div className='videoMetaData py-2'>
         ...
         <div className='videoMetaData__top'>
            ...
            <div className='d-flex justify-content-between align-items-center py-1'>
               <span>
                  {numeral(viewCount).format('0.a')} Views • {moment(publishedAt).format('MMM D,YYYY')}
               </span>

               <div className="d-flex align-items-center">
                  <span className='me-3 d-flex align-items-center justify-content-center'>
                     <MdThumbUp size={26} className={`me-2 ${
               liked && `text-primary`
            }`} onClick={() => {
               setLiked(true)
               setDisliked(false)
                  ...
                  <span className='d-flex align-items-center justify-content-center'>
                     <MdThumbDown size={26} className={`me-2 ${
         ...
         <div className='videoMetaData__channel d-flex justify-content-between align-items-center my-2 py-3'>
            <div className='d-flex'>
               ...
               />
               <div className='d-flex align-items-start justify-content-center flex-column p-2'>
